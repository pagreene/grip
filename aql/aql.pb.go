...
type EdgeGen struct {
	...
	FromLabel string `protobuf:"bytes,2,opt,name=from_label,json=fromLabel" json:"from_label,omitempty"`
	ToLabel   string `protobuf:"bytes,3,opt,name=to_label,json=toLabel" json:"to_label,omitempty"`
...
type isEdgeGen_Build interface{ isEdgeGen_Build() }

type EdgeGen_Unzip struct {
	Unzip *GenMatch `protobuf:"bytes,5,opt,name=unzip,oneof"`
}
type EdgeGen_Range struct {
	Range *GenMatch `protobuf:"bytes,6,opt,name=range,oneof"`
}
type EdgeGen_Match struct {
	Match *GenMatch `protobuf:"bytes,7,opt,name=match,oneof"`
}
...
func (m *EdgeGen) GetFromLabel() string {
	if m != nil {
		return m.FromLabel
	}
	return ""
...
func (m *EdgeGen) GetToLabel() string {
	if m != nil {
		return m.ToLabel
	}
	return ""
...
type EdgeGenCreate struct {
	Graph string   `protobuf:"bytes,1,opt,name=graph" json:"graph,omitempty"`
	Gen   *EdgeGen `protobuf:"bytes,2,opt,name=gen" json:"gen,omitempty"`
}

func (m *EdgeGenCreate) Reset()                    { *m = EdgeGenCreate{} }
func (m *EdgeGenCreate) String() string            { return proto.CompactTextString(m) }
func (*EdgeGenCreate) ProtoMessage()               {}
func (*EdgeGenCreate) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{10} }

func (m *EdgeGenCreate) GetGraph() string {
	if m != nil {
		return m.Graph
	}
	return ""
...
func (m *EdgeGenCreate) GetGen() *EdgeGen {
	if m != nil {
		return m.Gen
	}
	return nil
...
func (*Vertex) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{11} }
...
func (*Edge) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{12} }
...
func (*GraphID) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{18} }
...
func (*ElementID) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{19} }
...
func (*IndexID) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{20} }
...
func (*IndexQuery) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{21} }
...
func (*IndexTermCount) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{22} }
...
func (*Timestamp) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{23} }
...
func init() {
	...
	proto.RegisterType((*EdgeGenCreate)(nil), "aql.EdgeGenCreate")
...
type QueryClient interface {
	...
	ListEdgeGen(ctx context.Context, in *GraphID, opts ...grpc.CallOption) (Query_ListEdgeGenClient, error)
	GetEdgeGen(ctx context.Context, in *ElementID, opts ...grpc.CallOption) (*EdgeGen, error)
...
func (c *queryClient) ListEdgeGen(ctx context.Context, in *GraphID, opts ...grpc.CallOption) (Query_ListEdgeGenClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_Query_serviceDesc.Streams[4], c.cc, "/aql.Query/ListEdgeGen", opts...)
	if err != nil {
		return nil, err
	}
	x := &queryListEdgeGenClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type Query_ListEdgeGenClient interface {
	Recv() (*ElementID, error)
	grpc.ClientStream
}

type queryListEdgeGenClient struct {
	grpc.ClientStream
}

func (x *queryListEdgeGenClient) Recv() (*ElementID, error) {
	m := new(ElementID)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (c *queryClient) GetEdgeGen(ctx context.Context, in *ElementID, opts ...grpc.CallOption) (*EdgeGen, error) {
	out := new(EdgeGen)
	err := grpc.Invoke(ctx, "/aql.Query/GetEdgeGen", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) IndexTraversal(ctx context.Context, in *IndexQuery, opts ...grpc.CallOption) (Query_IndexTraversalClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_Query_serviceDesc.Streams[5], c.cc, "/aql.Query/IndexTraversal", opts...)
	if err != nil {
		return nil, err
	}
...
type QueryServer interface {
	...
	ListEdgeGen(*GraphID, Query_ListEdgeGenServer) error
	GetEdgeGen(context.Context, *ElementID) (*EdgeGen, error)
...
func _Query_ListEdgeGen_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(GraphID)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(QueryServer).ListEdgeGen(m, &queryListEdgeGenServer{stream})
}

type Query_ListEdgeGenServer interface {
	Send(*ElementID) error
	grpc.ServerStream
}

type queryListEdgeGenServer struct {
	grpc.ServerStream
}

func (x *queryListEdgeGenServer) Send(m *ElementID) error {
	return x.ServerStream.SendMsg(m)
}

func _Query_GetEdgeGen_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ElementID)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(QueryServer).GetEdgeGen(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/aql.Query/GetEdgeGen",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(QueryServer).GetEdgeGen(ctx, req.(*ElementID))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetEdgeGen",
			Handler:    _Query_GetEdgeGen_Handler,
		},
		{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "ListEdgeGen",
			Handler:       _Query_ListEdgeGen_Handler,
			ServerStreams: true,
		},
		{
...
type EditClient interface {
	...
	AddEdgeGen(ctx context.Context, in *EdgeGenCreate, opts ...grpc.CallOption) (*EditResult, error)
	DeleteEdgeGen(ctx context.Context, in *ElementID, opts ...grpc.CallOption) (*EditResult, error)
}
...
func (c *editClient) AddEdgeGen(ctx context.Context, in *EdgeGenCreate, opts ...grpc.CallOption) (*EditResult, error) {
	out := new(EditResult)
	err := grpc.Invoke(ctx, "/aql.Edit/AddEdgeGen", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *editClient) DeleteEdgeGen(ctx context.Context, in *ElementID, opts ...grpc.CallOption) (*EditResult, error) {
	out := new(EditResult)
	err := grpc.Invoke(ctx, "/aql.Edit/DeleteEdgeGen", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type EditServer interface {
	...
	AddEdgeGen(context.Context, *EdgeGenCreate) (*EditResult, error)
	DeleteEdgeGen(context.Context, *ElementID) (*EditResult, error)
}
...
func _Edit_AddEdgeGen_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(EdgeGenCreate)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(EditServer).AddEdgeGen(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/aql.Edit/AddEdgeGen",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EditServer).AddEdgeGen(ctx, req.(*EdgeGenCreate))
	}
	return interceptor(ctx, in, info, handler)
}

func _Edit_DeleteEdgeGen_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ElementID)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(EditServer).DeleteEdgeGen(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/aql.Edit/DeleteEdgeGen",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EditServer).DeleteEdgeGen(ctx, req.(*ElementID))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Edit_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "AddEdgeGen",
			Handler:    _Edit_AddEdgeGen_Handler,
		},
		{
			MethodName: "DeleteEdgeGen",
			Handler:    _Edit_DeleteEdgeGen_Handler,
		},
	},
	Streams: []grpc.StreamDesc{
		{
...
var fileDescriptor0 = []byte{
	...
	,
}
